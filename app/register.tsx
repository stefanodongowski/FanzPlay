            ...
            <ScrollView contentContainerStyle={styles.scrollView}>
                <View style={styles.container}>
                    ...
                    <View style={styles.input}>
                        ...
                        <TextInput placeholder='Email' placeholderTextColor='white' autoCapitalize='none' style={styles.textInput}
                            onChangeText={(text) => setEmail(text)}>
                        </TextInput>
                    </View>
                    <View style={styles.input}>
                        <MaterialCommunityIcons name="account-outline" size={24} color="white" />
                        <TextInput placeholder='First Name' placeholderTextColor='white' autoCapitalize='none' style={styles.textInput}
                            onChangeText={(text) => setFirstName(text)}>
                        </TextInput>
                    </View>
                    <View style={styles.input}>
                        <MaterialCommunityIcons name="account-outline" size={24} color="white" />
                        <TextInput placeholder='Last Name' placeholderTextColor='white' autoCapitalize='none' style={styles.textInput}
                            onChangeText={(text) => setLastName(text)}>
                        </TextInput>
                    </View>
                    <View style={styles.input}>
                        <MaterialCommunityIcons name="at" size={24} color="white" />
                        <TextInput placeholder='Username' placeholderTextColor='white' autoCapitalize='none' style={styles.textInput}
                            onChangeText={(text) => setUsername(text)}>
                        </TextInput>
                    </View>
                    <View style={styles.input}>
                        <MaterialCommunityIcons name="lock-outline" size={24} color="white" />
                        <TextInput placeholder='Password' secureTextEntry={true} placeholderTextColor='white' autoCapitalize='none' style={styles.textInput}
