...
const AdminGameCard: React.FC<AdminGameCardProps> = ({ game }) => {
  ...
  const [showAdminSelectQuestion, setShowAdminSelectQuestion] = useState(false);
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.buttonContainer}>
          ...
          {gameState !== 'inactive' && (<Pressable style={({ pressed }) => [styles.button, styles.manageButton, pressed && styles.buttonPressed]} onPress={() => setShowAdminManageGame(true)}>
